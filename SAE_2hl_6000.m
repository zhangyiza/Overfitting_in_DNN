function [nn,er] = SAE_2hl_6000(dropoutFrac, weightPenalty, inputZeroFrac)
%% train a 50-50 hidden unit SDAE and use it to initialize a FFNN
%% with provided parameters dropoutFrac, weightPenalty, inputZeroFrac
%% for sample of size 6000(10% sample)
...
opts.numepochs =   10;   %再trainnumepoch*4次
